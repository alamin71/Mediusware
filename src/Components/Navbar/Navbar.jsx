...
//         {/* Dropdown Menu */}
//         <ul className="absolute hidden md:group-hover:grid bg-white rounded-lg text-black shadow-lg mt-11 w-svw grid-cols-5 gap-4 p-4 ">
//           <div>
//             <h2 className="text-customGreen">About</h2>
//             <Link to="/service">
...
//         {/* Dropdown Menu */}
//         <ul className="absolute hidden md:group-hover:grid bg-white rounded-lg text-black shadow-lg mt-11 w-screen grid-cols-4 gap-2 p-4 ">
//           <div>
//             <h2 className="text-customGreen">About</h2>
//             <Link to="/industries">
...
//         <div tabIndex={0} role="button" className="lg:hidden md:hidden">
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
//             fill="none"
//             viewBox="0 0 24 24"
...
//         <ul
//           tabIndex={0}
//           className="menu menu-sm dropdown-content bg-gray-500 rounded-box z-[1] mt-3 p-2 shadow-lg w-screen"
//         >
//           {links}
//           {links2}
...
//         {/* Dropdown Menu */}
//         <ul className="absolute hidden group-hover:grid bg-white rounded-lg text-black shadow-lg mt-1 py-6 w-svw grid-cols-5 gap-4 p-4 ">
//           <div>
//             <h2 className="text-customGreen">About</h2>
//             <Link to="/company">
//               <li className=" py-2 hover:bg-gray-100">Who we are</li>
...
//         {/* Dropdown Menu */}
//         <ul className="absolute hidden md:group-hover:grid bg-white rounded-lg text-black shadow-lg mt-1 py-6 w-svw grid-cols-5 gap-4 p-4 ">
//           <div>
//             <h2 className="text-customGreen">About</h2>
//             <Link to="/service">
//               <li className=" py-2 hover:bg-gray-100">Service</li>
...
//         {/* Dropdown Menu */}
//         <ul className="absolute hidden md:group-hover:grid bg-white rounded-lg text-black shadow-lg  mt-1 py-6 w-screen grid-cols-4 gap-2 p-4 ">
//           <div>
//             <h2 className="text-customGreen">About</h2>
//             <Link to="/industries">
//               <li className=" py-2 hover:bg-gray-100">Industries</li>
...
//   return (
//     <nav className="flex justify-between px-3 py-2 bg-white  w-full shadow-2xl">
//       <Link to="/">
//         <img src={logo} alt="logo" />
//       </Link>
...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      <li className="relative group">
        ...
        <ul
          className={`absolute ${
            menuOpen ? "ml-36 top-0 bg-gray-100 md:ml-0" : ""
          } hidden group-hover:grid bg-white rounded-lg text-black shadow-lg mt-1 py-6 w-svw grid-cols-5 gap-4 p-4`}
        >
          <div>
            <h2 className="text-customGreen">About</h2>
            <Link to="/company">
      ...
      <li className="relative group">
        ...
        <ul
          className={`absolute ${
            menuOpen ? "ml-44 bg-gray-100 top-0 md:ml-0" : ""
          } hidden group-hover:grid bg-white rounded-lg text-black shadow-lg mt-1 py-6 w-svw grid-cols-5 gap-4 p-4`}
        >
          <div>
            <h2 className="text-customGreen">About</h2>
      ...
      <li className="relative group">
        ...
        <ul
          className={`absolute ${
            menuOpen ? "ml-36 top-0 md:ml-0" : ""
          } hidden group-hover:grid bg-white rounded-lg text-black shadow-lg mt-1 py-6 w-svw grid-cols-4 gap-4 p-4`}
        >
          <div>
            <h2 className="text-customGreen">About</h2>
            <Link to="/industries">
  ...
  return (
    <nav className="flex justify-between  items-center px-3 py-2 bg-white w-full shadow-2xl">
      <Link to="/">
        <img src={logo} alt="logo" />
      </Link>
      ...
      {menuOpen && (
        <div className="absolute top-16 left-0  bg-white shadow-md md:hidden">
