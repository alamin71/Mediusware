...
//     // Resetting any previous custom error messages
...
//     validateForm({ target: form }); // Validate form when submitting

//     if (!isFormValid) return; // Prevent submission if validation fails
...
//     console.log(name, email, phoneNumber, company, inQuery);
//   };

//   const handleInputChange = (e) => {
//     const form = e.currentTarget.form;
//     validateForm({ target: form }); // Validate form on each input change
//   };
...
//                 key={service}
//                 type="button"
//                 className="px-3 py-1 border rounded-md bg-gray-200 hover:bg-cusTomBtnHoverClr hover:text-customBtnTextClr text-black focus:bg-green-500 focus:text-white transition"
//               >
//                 {service}
//               </button>
//             ))}
...
const React_Assignment = () => {
  ...
  const handleSubmitForm = (e) => {
    ...
    console.log({
      ...
      company,
      inQuery,
      selectedServices, // Log selected services
      selectedBudget, // Log selected budget
    });
  };
