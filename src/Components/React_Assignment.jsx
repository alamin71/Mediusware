...
const React_Assignment = () => {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <form className="bg-white shadow-md rounded-lg p-6 max-w-4xl mx-auto">
        ...
        <div className="mt-4">
          <label className="block text-gray-700">Services You Need (You can choose multiple)</label>
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            ['Mobile Development', 'Web Development', 'SQA Solution', 'Web UX/UI Design', 'API Integration', 'Mobile UX/UI Design', 'Software Development', 'Custom Service'].map(service => (
              <button
                key={service}
                type="button"
                className="px-3 py-1 border rounded-md bg-gray-200 hover:bg-gray-300 focus:bg-green-500 focus:text-white transition"
              >
                {service}
              </button>
            ))}
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {
            ['Less than $500', '$500 - $1,000', '$1,001 - $1,500', '$1,500 - $2,000'].map(budget => (
              <button
                key={budget}
                type="button"
                className="px-3 py-1 border rounded-md bg-gray-200 hover:bg-gray-300 focus:bg-green-500 focus:text-white transition"
        ...
        <div className="mt-4">
          <label className="block text-gray-700">Deep Details About Your Query (Optional)</label>
          <textarea
            className="w-full p-2 border rounded-md mt-1"
        ...
        <div className="mt-4">
          <label className="block text-gray-700">Add Attachments (Optional)</label>
          <input type="file" 
          className="w-full p-2 border rounded-md mt-1" 
          />
        </div>
